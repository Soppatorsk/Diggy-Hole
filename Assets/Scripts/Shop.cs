...
public class Shop : MonoBehaviour
{
    ...
    static Item item_1 = new Item(0, "Pickaxe", "No more punching!", 10, 1.5, 1); //clickinc, not autoinc
    static Item item_2 = new Item(1, "Fan", "Keep cool!", 200, 1.2, 10);
    static Item item_3 = new Item(2, "Mead", "Alcohol!", 1000, 1.4, 20);
    static Item item_4 = new Item(3, "Waifu", "2D > 3D!", 10000, 1.6, 30);
    ...
    static Item item_13 = new Item(12, "Sacrifice", "Poor goat!", 250000000, 2.7, 25000);
    static Item item_14 = new Item(13, "Alchemy", "Equivalent Exchange!", 500000000, 2.8, 50000);
    static Item item_15 = new Item(14, "Plasma Ray", "Ray go brrrr!", 750000000, 2.9, 75000);
    static Item item_16 = new Item(15, "Ascended", "BEYOND DWARF", 1000000000, 3, 100000);
    static Item item_17 = new Item(16, "Mine God", "", 0, 1, 999999999); //DEBUG ITEM
