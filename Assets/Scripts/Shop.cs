...
public class Shop : MonoBehaviour
{
    ...
    static Item item_1 = new Item(0, "Pickaxe",         1, 1, 10); //
    ...
    static Item item_8 = new Item(7, "Shoulders",   5000000, 10000, 100);
    static Item item_9 = new Item(8, "Bank",            10000000, 200, 200);
    static Item item_10 = new Item(9, "Drill",          200000000, 500, 500);
    static Item item_11 = new Item(10, "Robot Arm",     5000000000, 1000, 1000);
    static Item item_12 = new Item(11, "Stocks",        5000, 5000, 5000);
    static Item item_13 = new Item(12, "Sacrifice",     10000, 10000, 10000);
    static Item item_14 = new Item(13, "Alchemy",  20000, 20000, 20000);
